...
public class RNCWebViewManager extends ViewGroupManager<RNCWebViewWrapper>
    ...
    @Override
    @ReactProp(name = "offscreenPreRaster")
    public void setOffscreenPreRaster(RNCWebViewWrapper view, boolean value) {
        mRNCWebViewManagerImpl.setOffscreenPreRaster(view, value);
    }
